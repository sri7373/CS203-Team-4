 ...
 * 
 * Uses H2 in-memory database for testing (isolated from production AWS
 * database).
 */
@SpringBootTest
...
class AuthControllerTest {
    ...
    // NOTE: This test is commented out because the application uses @NotBlank
    // validation
    // which rejects whitespace-padded values. The application does NOT trim
    // whitespace
    ...
    void register_ShouldGenerateValidJwtToken_UponSuccessfulRegistration() throws Exception {
        ...
        // Extract token from JSON response (simplified - in real test you'd use JSON
        // parser)
